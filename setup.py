...
setup(name='pyserializer',
      version="0.0.1",
      description="A library for serialization of Python objects.",
      long_description=open('README.md').read(),
      classifiers=[
        "Development Status :: 5 - Production/Stable"
      ],
      download_url="https://github.com/deptofdefense/pyserializer/zipball/main",
      python_requires='>=3.9',
      keywords='python data',
      author='DDS Developers',
      author_email='code@dds.mil',
      url='https://github.com/deptofdefense/pyserializer',
      packages=[
        'pyserializer',
      ],
      package_data={
